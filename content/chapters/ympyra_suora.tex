...
\begin{alakohdat}
\alakohta{Jos $P = (0,0)$, $O = (6,4)$ ympyrän säde on $5$, määritä sivuamispisteet.}
...
\begin{tehtava}
Todista analyyttisen geometrian keinoin, että ympyrälle piirretty tangentti ja tangentin sivuamispisteeseen piirretty säde ovat kohtisuorassa.
\begin{vastaus}
Vinkki: Yleisyyttä menettämättä voidaan ympyrä asettaa origokeskiseksi ja yksisäteiseksi. Käytä tehtävän ? tulosta ja kohtisuoruusehtoa.
\end{vastaus}
\end{tehtava}
