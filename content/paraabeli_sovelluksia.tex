...
%%% Jatkoa edellisen teemaan
\begin{tehtava}
Osoita miksi paraabeli $y = ax^2 +bx +c$ on symmetrinen huippunsa kautta kulkevan $y$-akselin suuntaisen suoran suhteen.
%%% Tämähän onnistuu varmaan vaikka miten (esim. geom. määritelmästä). Kaikki helppoja, mutta varmaan kaikein helpoin: Ol. paraabelin yleinen piste (x_0, y_0). Kiinnitetään yhtälössä y =y_0: x_0:lle yhtälö ratkaisukaavasta...
\begin{vastaus}
...
%%%Jatkona edelliseen, tähän jokin soveltavampi 'geometrinen' ääriarvotehtävä jossa funktio toista astetta
