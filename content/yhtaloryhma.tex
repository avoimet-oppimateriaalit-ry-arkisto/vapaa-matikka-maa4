...
\begin{tehtava}
  ...
  \begin{alakohdat}
    ...
    \alakohta{Entä jos yhtälöryhmään lisätään neljäs tai useampi suora?}
    \alakohta{Milloin kahden muuttujan lineaarisessa yhtälöryhmässä on enemmän muuttujia kuin yhtälöitä? Montako ratkaisua tällöin on?} 
  \end{alakohdat}
  \begin{vastaus}
    \begin{alakohdat}
      \alakohta{Kolme tason suoraa voivat olla keskenään yhdensuuntaisia leikkaamatta toisiaan (0 ratkaisua), leikata kaikki toisensa samassa pisteessä (1 ratkaisu) tai olla saman suoran yhtälöitä(äärettömän monta ratkaisua). Suorat voivat myös leikata toisiaan siten, että kolmesta suorasta kaksi leikkaavat toisensa jossain pisteessä, jonka kautta kolmas suora ei kuitenkaan kulje. Tällöin ratkaisuja on myös 0 (piirrä kuva.)

        Ratkaisuja on 0, 1 tai äärettömän paljon.
      }
      \alakohta{Sama kuin yllä pätee kun suoria lisätään.}
      \alakohta{'Yhtälöryhmässä' on tällöin vain yksi suoran yhtälö.}
    \end{alakohdat}
  \end{vastaus}
\end{tehtava}
