...
\begin{alakohdat}
		\alakohta{Missä pisteissä suora $y=-3x+12$ leikkaa koordinaattiakselit?}
		\alakohta{Ratkaise yhtälöpari 
		\[
\left\{
\begin{aligned}
 2x+y=4  \\
...
\begin{alakohdat}
		...
		\alakohta{Ratkaise yhtälö $x^2+14=-49$.}
		\alakohta{Suora kulkee origon ja pisteen $(2,3)$ kautta. Kulkeeko se myös pisteen $(48,75)$ kautta?}
	\end{alakohdat}
\end{tehtava}
%Lisännyt Aleksi Sipola 17.5.2014
...
\begin{alakohdat}
		\alakohta{Funktion $f(x)=\frac{3}{2}x+b$ nollakohta $2$. Määritä vakion $b$ arvo}
		\alakohta{Ratkaise yhtälö $x^2+14=-49$.}
		\alakohta{Suora kulkee origon ja pisteen $(2,3)$ kautta. Kulkeeko se myös pisteen $(48,75)$ kautta?}
	\end{alakohdat}
\end{tehtava}
...
\begin{alakohdat}
		\alakohta{Ratkaise yhtälö $x^2-2x=0$.}
		\alakohta{Ratkaise yhtälö $\frac{2}{3}x-1=\frac{2}{3}$.}
		\alakohta{Ratkaise yhtälöpari
		\[
\left\{
\begin{aligned}
...
mukaisesti,kun yksikkönä on senttimetri.
  ...
  \begin{alakohdat}
		\alakohta{Arkeologi löytää naisen sääriluun, joka on 41 cm pitkä. Kuinka pitkä nainen oli?}
		\alakohta{Kaivauksissa löytyneen miehen pituudeksi arvioidaan 175 cm. Miehen läheltä löytyy sääriluu, jonka pituus on 42 cm. Onko  kyseessä saman henkilön sääriluu?}		
  \end{alakohdat}
...
\begin{alakohdat}
		\alakohta{Ratkaise yhtälö $4x+(5x-4)=12+3x$.}
		\alakohta{Sievennä lauseke $x^2+x-(x^2-x)$ ja laske sen arvo, kun $x=\frac{1}{2}$}
		\alakohta{Ratkaise yhtälöpari
		\[
\left\{
\begin{aligned}
...
\begin{alakohdat}
		\alakohta{Suoran kulmakerroin on $-\frac{1}{3}$, ja suora kulkee pisteen $(-1,2)$ kautta. Esitä suoran yhtälö muodossa $y=kx+b$}
		\alakohta{Tutki, millä muuttujan $x$ arvoilla polynomi $2x^2+5x-3$ saa negatiivisia arvoja.}
	\end{alakohdat}
\end{tehtava}
%Lisännyt Aleksi Sipola 17.5.2014
...
\begin{alakohdat}
		\alakohta{Määritä sen tetraedrin tilavuus, jonka kärjet ovat origossa $O$ sekä pisteissä $A$,$B$ ja $C$. }
		\alakohta{Määritä kolmion $ABC$ pinta-ala}
	\end{alakohdat}
% 	VASTAUKSET EIVÄT MENE VASTAUS OSIOON VAAN JÄÄVÄT TEHTÄVÄNANNON PERÄÄN 
%  \begin{vastaus} 
%	 Tilavuus on $6$
...
\begin{alakohdat}
		\alakohta{Ratkaise yhtälöä $x^2+6x=2x^2+9$.}
		\alakohta{Ratkaise yhtälö $\frac{1+x}{1-x}=\frac{1-x^2}{1+x^2}$}
		\alakohta{Esitä polynomi $x^2-9x+14$}
	\end{alakohdat}
\end{tehtava}
%Lisännyt Aleksi Sipola 17.5.2014
...
\begin{alakohdat}
		\alakohta{Ratkaise yhtälöä $(x-4)^2=(x-4)(x+4)$.}
		\alakohta{Ratkaise epäyhtälöä $\frac{3}{5}x-\frac{7}{10} < -\frac{2}{15}x$.}
		\alakohta{Suora kulkee pisteiden $(1,7)$ ja $2,4$ kautta. Missä pisteessä se leikkaa $x$-akselin}
	\end{alakohdat}
\end{tehtava}
%Lisännyt Aleksi Sipola 17.5.2014
...
\begin{tehtava} (S2012/1) Ratkaise yhtälöt
  \begin{alakohdat}
		\alakohta{$2(1-3x+3x^2)=3(1+2x+2x^2)$}
		\alakohta{$|x|=1+x$}
		\alakohta{$1-x=\frac{1}{1-x}$}	
  \end{alakohdat}
\end{tehtava}
%Lisännyt Aleksi Sipola 17.5.2014
...
\begin{alakohdat}
		...
		\alakohta{tällaista lieriötä ei ole olemassa (2p.)}
...
\begin{tehtava}(K2009/1 a ja b)
  \begin{alakohdat}
		\alakohta{Ratkaise epäyhtälö $(x-3)^2=(x-1)(x+1)$}
		\alakohta{Määritä suorien $\frac{x}{3}+\frac{y}{2}=1$ ja $3x-2y+3=0$ leikkauspiste}	
  \end{alakohdat}
\end{tehtava}
