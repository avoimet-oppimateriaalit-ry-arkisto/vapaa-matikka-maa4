...
\chapter{Esitietoja}
	\input{content/itseisarvo}
	\newpage \input{content/epayhtalo}
	% itseisarvoepäyhtälöt
	\newpage \input{content/yhtaloryhma}
	% sijoitusmenetelmä
	% yhtälöiden laskeminen yhteen
	% ratkaisujen määrä
	\newpage \input{content/koordinaatisto}
...
\chapter{Suorat}
	...
	\newpage \input{content/suora_esitykset}
